...
export const StatsPage = () => {
  const [priceHistory, setPriceHistory] = useState<BottlePriceHistory | null>(
    null,
  );
  ...
  const fetchMoneyHistory = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        console.error("Failed to fetch money history");
      }
    } catch (err) {
      console.error("Failed to fetch money history:", err);
    } finally {
        ...
        <VStack align="stretch" spacing={6}>
          {performanceStats ? (
            <>
              ...
              <Box>
                ...
                <HStack spacing={4} justify="space-around" flexWrap="wrap">
                  ...
                  <Stat textAlign="center" minW="150px">
                    ...
                    <StatNumber color="purple.400">
                      {performanceStats.cache.hit_rate}%
                    </StatNumber>
                ...
                <Box mt={6}>
                  ...
                  <Progress
                    ...
                    colorScheme={
                      performanceStats.cache.hit_rate > 80
                        ? "green"
                        : performanceStats.cache.hit_rate > 50
                          ? "yellow"
                          : "red"
                    }
                    size="lg"
              ...
              <Box>
                <Heading size="md" mb={4} color="white">
                  ⚡ API-Endpunkt Performance
                </Heading>

                {Object.entries(performanceStats).filter(
                  ([key]) => key !== "cache",
                ).length > 0 ? (
                  <>
                    {/* Performance Chart */}
                          ...
                          data={Object.entries(performanceStats)
                            ...
                            .map(([endpoint, stats]) => ({
                              endpoint: endpoint
                                ...
                                .replace("PUT ", ""),
                              avg_time:
                                (stats as PerformanceEndpoint).avg_time * 1000,
                        ...
                        >
                          ...
                          <Bar dataKey="avg_time" radius={[8, 8, 0, 0]}>
                            {Object.entries(performanceStats)
                              ...
                              .map(([, stats], index) => {
                                const avgTime =
                                  (stats as PerformanceEndpoint).avg_time *
                                  1000;
                                const color =
                                  avgTime < 100
                                    ? "#48BB78"
                      ...
                      <Table variant="simple" size="sm">
                        ...
                        <Tbody>
                          {Object.entries(performanceStats)
                            ...
                            .sort(
                              ([, a], [, b]) =>
                                (b as PerformanceEndpoint).requests -
                                (a as PerformanceEndpoint).requests,
                            )
                            .map(([endpoint, stats]) => {
                              ...
                              return (
                                <Tr key={endpoint}>
                                  ...
                                  <Td color="purple.300" isNumeric>
                                    {avgMs.toFixed(2)} ms
                                  </Td>
                                  <Td color="green.300" isNumeric>
                                    {(s.min_time * 1000).toFixed(2)} ms
                                  </Td>
                                  <Td color="orange.300" isNumeric>
                                    {(s.max_time * 1000).toFixed(2)} ms
                                  </Td>
                                  <Td>
                                    <Badge
              ...
              >
                <Text fontSize="sm" color="purple.200">
                  ⚡ Performance-Metriken werden bei jeder API-Anfrage
                  automatisch erfasst. Der Cache reduziert unnötige API-Aufrufe
        ...
        <VStack align="stretch" spacing={6}>
          ...
          <HStack spacing={4} justify="space-around" flexWrap="wrap">
            <Stat textAlign="center" minW="150px">
              ...
              <StatNumber color="green.400">
                €
                {(moneyHistory?.current_amount || 0).toLocaleString("de-DE", {
              ...
              <StatHelpText>
                {moneyStats.trend > 0 && (
                  <HStack justify="center" color="green.400">
                    ...
                    <Text>
                      +€
                      {moneyStats.trend.toLocaleString("de-DE", {
                        minimumFractionDigits: 2,
                      })}
                    </Text>
                  </HStack>
                ...
                {moneyStats.trend < 0 && (
                  <HStack justify="center" color="red.400">
                    ...
                    <Text>
                      -€
                      {Math.abs(moneyStats.trend).toLocaleString("de-DE", {
                        minimumFractionDigits: 2,
                      })}
                    </Text>
                  </HStack>
                )}
                {moneyStats.trend === 0 && <Text color="gray.400">Stabil</Text>}
              </StatHelpText>
            </Stat>
            ...
            <Stat textAlign="center" minW="150px">
              ...
              <StatNumber color="red.400">
                €
                {moneyStats.min.toLocaleString("de-DE", {
                  minimumFractionDigits: 2,
                })}
              </StatNumber>
            ...
            <Stat textAlign="center" minW="150px">
              ...
              <StatNumber color="green.400">
                €
                {moneyStats.max.toLocaleString("de-DE", {
                  minimumFractionDigits: 2,
                })}
              </StatNumber>
            ...
            <Stat textAlign="center" minW="150px">
              ...
              <StatNumber color="purple.400">
                €
                {moneyStats.avg.toLocaleString("de-DE", {
                  minimumFractionDigits: 2,
                })}
              </StatNumber>
              ...
              <ResponsiveContainer width="100%" height={400}>
                <AreaChart data={moneyChartData}>
                  ...
                  <Tooltip
                    ...
                    labelFormatter={(value) => `Messpunkt ${value}`}
          ...
          >
            <Text fontSize="sm" color="green.200">
              💰 Dein Geldbestand wird bei jeder Aktualisierung automatisch
              erfasst. Die letzten 50 Änderungen werden gespeichert und hier als
              Graph dargestellt.
            </Text>
          </Box>
        </VStack>
        ...
        <VStack align="stretch" spacing={6}>
          ...
          <HStack spacing={4} justify="space-around" flexWrap="wrap">
            <Stat textAlign="center" minW="150px">
              ...
              <StatHelpText>
                ...
                {stats.trend === 0 && <Text color="gray.400">Stabil</Text>}
              </StatHelpText>
            </Stat>
          ...
          >
            <Text fontSize="sm" color="blue.200">
              💡 Der Pfandflaschenpreis wird bei jeder Aktualisierung
              automatisch erfasst. Die letzten 50 Preisänderungen werden
              gespeichert und hier als Graph dargestellt.
            </Text>
          </Box>
        </VStack>
      </DashboardCard>
