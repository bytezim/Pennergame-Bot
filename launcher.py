...
def start_frontend():
    ...
    print(
        "Backend Server ready at http://127.0.0.1:8000"
        if sys.platform != "win32"
        else "Backend Server ready at http://127.0.0.1:8000"
    )
    print(
        "Frontend Server ready at http://127.0.0.1:1420"
        if sys.platform != "win32"
        else "Frontend Server ready at http://127.0.0.1:1420"
    )
